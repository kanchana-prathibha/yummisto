...
import com.coffeeprogrammer.yummisto.CakeDetailActivityCustomer;
import com.coffeeprogrammer.yummisto.R;
import com.coffeeprogrammer.yummisto.models.Cake;

import java.util.List;

public class CakeAdapterCustomer extends RecyclerView.Adapter<CakeAdapterCustomer.CakeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CakeViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(holder.itemView.getContext(), CakeDetailActivityCustomer.class);
